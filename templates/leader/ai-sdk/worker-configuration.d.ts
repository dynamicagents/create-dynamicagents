/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc2b86c0e800a6be4f64fbcd560c3314)
...
interface __BaseEnv_Env {
	...
	GITHUB_NAME: string;
	GITHUB_EMAIL: string;
	LeaderAgent: DurableObjectNamespace<import("./src/index").LeaderAgent>;
	LEADER_WORKSPACE: DurableObjectNamespace<import("./src/index").LeaderWorkspaceDO>;
	ARTIFACTS: DurableObjectNamespace<import("./src/index").Artifacts>;
	LEADER_WORKFLOW: Workflow<Parameters<import("./src/index").LeaderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LeaderAgent" | "LeaderWorkspaceDO" | "Artifacts";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "A2A_SIGNING_KEY" | "GATEKEEPER_ORIGINS" | "GITHUB_TOKEN" | "GITHUB_NAME" | "GITHUB_EMAIL">> {}
}
