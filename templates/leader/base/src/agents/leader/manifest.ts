...
export const manifest: AgentManifest = {
  name: "Leader",
  description:
    "Leads a change through other agents. Give it a repository and a change to make; it clones into a Linux sandbox, delegates the implementation to its subagents, reviews what they did, runs the project's own tests, pushes a work branch and opens a pull request. Replies with the pull request URL. Never commits to a default branch.",
  version: "0.1.0",
