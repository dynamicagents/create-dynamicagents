 ...
 *
 * It sits at the top level rather than in the agent's directory because there
 * is nothing agent-specific here: the contract is about how a round ends, and
 * every one ends the same way. What the agent is told about its *domain* is
...
/**
 * Failure copy for any round: words for a question nobody
 ...
 * first and falls through to this — see `src/agents/leader/workflow.ts`.
 */
...
/** The round policy the leader runs under. */
