 ...
 * outage: a cancellation path that rebuilt its own — without `shell: "bash"` —
 * ran a cancelled task's cleanup under a different shell than every other
 * command in the same container. One definition is what stops
